function result = solveKmap(kmap)
% 
% kmap=[ 0  1  1  1;
%        0  1  1  1; 
%        0  0  0  1;
...
for i=0:3	
    ...
    if isequal(m,ones(2,4)+ones(2,4))
        ...
        if isequal(m,ones(2,4))
            ...
            temp = [temp '__'];
            result = [result ' + ' myconvert(temp)];   % disp(myconvert(temp));  % for horizontal
    ...
    if isequal(m,ones(4,2)+ones(4,2))
        ...
        if isequal(m,ones(4,2))
            ...
            temp = ['__' temp];
            result = [result ' + ' myconvert(temp)];   % disp(myconvert(temp));  % for vertical
...
for i=0:3
    ...
    if isequal(m,ones(1,4)+ones(1,4))
        ...
        if isequal(m,[1 1 1 1])
            ...
            result = [result ' + ' myconvert(temp)];   % disp(myconvert(temp));
            kmap(i+1,:) = 2;
        end
    end
