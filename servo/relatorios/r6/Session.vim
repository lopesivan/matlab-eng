...
silent only
cd ~/github/matlab-eng/servo/relatorios/r6
...
setlocal statusline=%!PowerlinePyeval('powerline.statusline(5)')
setlocal suffixesadd=.m
setlocal swapfile
setlocal synmaxcol=3000
if &syntax != 'matlab'
