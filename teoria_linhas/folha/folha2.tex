...
\title{Formulário de Linhas e Transmissão}
...
\begin{abstract}
%\boldmath
Fórmulas para a disciplina de linhas e transmissão 
...
%Indutância em uma linha monofásica ou trifásica.
...
%Onde $R'$ é chamado de raio efetivo.
...
%Capacitância para linhas trifásica assimétricas,
...
%Onde $R$ é o raio real do condutor(não confundir com o raio efetivo para
%análise da indutância).
...
%\begin{tabular}{|c||c||c|}
%    \hline
%    Modelo LT & \multicolumn{2}{|c|}{Parâmetro} \\
%    \hline
%    {}  & A & B  \\
%    \hline
%    Curta & 1 & $Z$   \\
%    \hline
%    Média $\pi$ & $1 + \frac{Z Y}{2}$ & $Z$ & $Y (1+\frac{Z Y}{2})$ & $1+\frac{Z Y}{2}$ \\
%Média $\pi$ & $1 + \frac{Z Y}{2}$ & $Z$\\
%    \hline
%
%    Média $T$ & $1+\frac{Z Y}{2}$ & $Z (1+\frac{Z Y}{2})$ & Y & $ 1 +  \frac{Z Y}{2}$ \\
%Média $T$ & $1+\frac{Z Y}{2}$ & $Z (1+\frac{Z Y}{2})$ \\
%    \hline
%    {} & {} & {} \\
%    {} & C & D \\
%    \hline
%    Curta & 0 & 1 \\
%    \hline
%    Média $\pi$ & $Y (1+\frac{Z Y}{2})$ & $1+\frac{Z Y}{2}$ \\
%    \hline
%    Média $T$ &  Y & $ 1 +  \frac{Z Y}{2}$ \\
%    \hline
%\end{tabular}
%\end{center}
...
\begin{center}
    ...
    \begin{tabular}{|c||c||c||c|}
        ...
        B & $Z$ & $Z$  & $ Z \left( 1 + \frac{Z Y}{4}\right)$ \\
        C & 0 &  $ Y \left(1 + \frac{Z Y}{4}\right)$ &  $Y$ \\
...
\begin{center}
    ...
    \begin{circuitikz}[scale=.8] \draw
        ...
        (2.5,3) to[L=$\frac{X_L}{2}$] (4.5,3)
        (4.5,3) to[R=$\frac{R}{2}$] (6.5,3)
        (6.5,3) to[L=$\frac{X_L}{2}$] (8.5,3)
        (4.5,0) to[C=$Y'$] (4.5,3)
