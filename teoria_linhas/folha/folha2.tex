...
\title{Formulário de Linha e Transmissão}
...
\begin{abstract}
%\boldmath
Fórmulas para a disciplina de linha e transmissão 
...
\begin{equation}
P_{modelada} = P \cdot \frac{V_{linha}}{V_{carga}}
\end{equation}
...
\begin{equation}
P_{modelada} =PCTE \cdot P +  ZCTE \cdot  P \cdot \frac{V_{linha}}{V_{carga}}
\end{equation}
...
\begin{equation}
    C = \frac{2\pi 8.85 \cdot 10^{-9}}{\ln \frac{D_m}{D_s}}
\end{equation}
