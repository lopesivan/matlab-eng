...
subtrair a energia irrecupéravel perdidade no núcleo pelo efeito Joule.
...
é necessário uma potência reativa que é obtidade na linha de alimentação,
...
transformador(EMS 8341) disponivel no laboratório.\\
...
Tensão entre os seguintes terminais de conecção,
\begin{center}
    \begin{tabular}{|c||c|}
        \hline 
        Terminais & VCA[V] \\
...
Corrente nominal de cada uma das seguintes conecções,
\begin{center}
    \begin{tabular}{|c||c|}
        \hline 
        Terminais & ACA[A] \\
...
As tensões de entrada(Vp), saída(Vs) e corrente(Io) de entrada foram medidas.
Para a medição da corrente do secundário foi colocado um amperimetro.
...
Mudando a configuração do secundário para 3 e 4 do transformador
